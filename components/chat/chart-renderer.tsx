...
import {registry, Fallback} from "@/components/chat/json-render-registry";
 ...
 */
export function VisualizationRenderer({spec, loading}: { spec: Spec, loading: boolean }) {
	console.log(spec, loading)
	return (
